...
class AdMobService {
  // NOTE: Using real ad units for production.
  //
  static String get bannerAdUnitId {
    if (Platform.isAndroid) {
      return 'ca-app-pub-4384120827738431/2390002413';
    } else if (Platform.isIOS) {
      return 'ca-app-pub-4384120827738431/2390002413'; // Using same ID for now, update if different
    }
  ...
  static String get interstitialAdUnitId {
    if (Platform.isAndroid) {
      ...
      return 'ca-app-pub-4384120827738431/4237560263'; // Using same ID for now, update if different
    }
    throw UnsupportedError("Unsupported platform");
  }
